...
// backend/modules/cheques/cheques_cartera/route.php
...
switch ($action) {
  case 'cheques_cartera_listar':
    require_once __DIR__ . '/cheques_cartera.php';
    exit;

  case 'cheques_cartera_comprobante_ver':
    require_once __DIR__ . '/cheques_cartera_comprobante_ver.php';
    exit;

  case 'cheques_cartera_depositar':
    require_once __DIR__ . '/cheques_cartera_depositar.php';
    exit;
  ...
  default:
    ...
    echo json_encode([
      'exito' => false,
      'mensaje' => 'Acción no válida para cheques en cartera.'
    ], JSON_UNESCAPED_UNICODE);
    exit;
}