...
function ChequePreview({ datos, tipo }) {
  ...
  return (
    <div
      className={["cheque-card", isEcheq ? "cheque-card--echeq" : ""].filter(Boolean).join(" ")}
...
export default function ModalNuevoChequeRecibo({
    ...
    setForm({
      ...
      importe:
        seedData?.importe != null && seedData?.importe !== ""
          ? String(seedData.importe)
          : "",
      fecha_pago: seedData?.fecha_pago || plusDaysISO(10),
    });

    if (seedData?.archivo instanceof File) {
      setArchivo(seedData.archivo);
      setArchivoNombre(
        seedData?.archivo_nombre || seedData.archivo?.name || seedData?.archivoName || ""
      );
    } else {
  ...
  }, [open, saving, onClose, openVerComp, compUrl]);
  ...
  const previewData = useMemo(
    () => ({
      ...form,
      importe: safeNumber(parseMoney(form.importe)),
    }),
    [form]
  );
  ...
  const handleSave = useCallback(() => {
    ...
    onSave?.({
      tipo: isEcheq ? "echeq" : "cheque",
      tipo_cheque: isEcheq ? "echeq" : "cheque",
  ...
  }, [saving, onSave, form, isEcheq, archivo, archivoNombre]);
  ...
  return createPortal(
    <>
      ...
      >
        <div
          className={["mi-modal__container", "mncr-modal-responsive", dark ? "mi-modal--dark" : ""]
            .filter(Boolean)
            .join(" ")}
          style={{
        ...
        >
          ...
          >
            <div className="mncr-layout">
              {/* IZQUIERDA: formulario */}
              <div className="mncr-left">
                  ...
                  <div className="nc-section-body">
                    ...
                    <div className="nc-field">
                      <input
                        ...
                        onChange={(e) => setField("numero_cheque", onlyNumbers(e.target.value))}
                        disabled={saving}
                        inputMode="numeric"
                        autoComplete="off"
                      />
              ...
              {/* DERECHA: preview + comprobante + acciones */}
              <div className="mncr-right">
                <div className="nc-section">
                  <div className="nc-section-head">
                    <div
                            ...
                            <>
                              ...
                              <div className="mi-uploadFile__meta">
                                <div
                                  ...
                                  title={archivoNombre || archivo.name}
                                >
                ...
                <div className="nc-actions" style={{ padding: 0 }}>
                  <button
                    ...
                    disabled={saving}
                  >
                    {saving ? "Guardando..." : `Confirmar ${isEcheq ? "eCheq" : "cheque"}`}
                  </button>
      ...
      {openVerComp && compUrl && (
        ...
        >
          ...
          >
            ...
            >
              {archivoNombre || archivo?.name || "Comprobante"}
            </span>
